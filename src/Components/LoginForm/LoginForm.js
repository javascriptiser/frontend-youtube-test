...
export const LoginForm = () => {
	...
	const toggleVisiblePasswordSvg = () => {
		setState({
			...state,
	...
	const showedPasswordSvg = <svg onClick={toggleVisiblePasswordSvg} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" >
	...
	const hiddenPasswordSvg = <svg onClick={toggleVisiblePasswordSvg} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
	...
	useEffect(() => {
		setState({
			visiblePasswordSvg: state.visiblePasswordSvg,
			typePasswordInput: state.visiblePasswordSvg ? "text" : "password"
		})
